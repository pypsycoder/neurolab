...
20. Выполнен дисциплинированный операционный редизайн панели: единый тёмный рабочий лист, локальная моноширинная телеметрия, янтарный тепловой сигнал и спокойные контрастные формы. Без декоративных boot-анимаций и ложных терминальных команд; интерфейс остаётся адаптивным и доступным с клавиатуры.
...
```text
/opt/neuro-lab/
  compose.yaml, .env (0600), docs/deployment/CONTROL_PLANE_PLAN.md, postgres/, orchestrator/, scripts/
/srv/neuro-lab/
  logs/, cache/, artifacts/
